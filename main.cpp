...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	//ID3D11Buffer* vertexBufferAxis = renderer.CreateVertexBuffer(mainAxis->GetVertexData(), mainAxis->GetVertexByteWidth());
	//mainAxis->SetVertexBuffer(vertexBufferAxis);
	...
	//USphereComponent* sphere = new USphereComponent();
 //   ID3D11Buffer     *vertexBufferSphere = renderer.CreateVertexBuffer(sphere->GetVertices(), sphere->GetVertexByteWidth());
	...
	//renderer.ReleaseVertexBuffer(vertexBufferAxis);
